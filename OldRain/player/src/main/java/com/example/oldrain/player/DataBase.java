...
public class DataBase {
    ...
    public void saveData(HashMap<String, Object> listItem, String db_name) {
    ...
    public void updataData(String tag, String change, String path,String db_name){
        db.execSQL("CREATE table IF NOT EXISTS "+ db_name
                + " (_id INTEGER PRIMARY KEY AUTOINCREMENT,playtag VARCHAR(300)," +
                "name VARCHAR(300), singer VARCHAR(300), album VARCHAR(300), path VARCHAR(300), lovetag VARCHAR(300))");
    ...
    public void deleteData(String name, String path, String db_name){
    ...
    public ArrayList<HashMap<String, Object>> getData(String db_name) {
